  ...
  return (
    <div className="fixed top-8 right-8 z-50 flex items-center gap-4 font-mono text-sm">
      ...
      <div className="flex flex-col items-end">
        ...
        <span className="text-black dark:text-white font-bold text-xl tracking-tighter">
          {xp.toLocaleString()}
        </span>
      </div>

      <div className="w-8 h-8 border border-gray-200 dark:border-zinc-800 rounded-full flex items-center justify-center">
